 ...
 * @description Sleek login page with form validation, loading states, and premium animations.
 */

import { useState } from 'react';
import { Link, useNavigate, useLocation } from 'react-router-dom';
import { motion } from 'framer-motion';
import { RiMailLine, RiLockPasswordLine, RiEyeLine, RiEyeOffLine, RiErrorWarningLine } from 'react-icons/ri';
    ...
    <div className="min-h-screen relative flex flex-col items-center justify-center p-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between mt-2 text-sm text-gray-400">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="accent-[#e50914] w-4 h-4 cursor-pointer" />
        ...
        <div className="mt-10 text-gray-400">
          <p>
            New to BappamMovies?{' '}
            <Link to={ROUTES.SIGNUP} className="text-white hover:underline font-semibold">
              Sign up now.
            </Link>
          </p>
